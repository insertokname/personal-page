...
export default function FileRow({ file }: FileRowProps) {
  return (
    <tr className="cursor-pointer hover:opacity-90 border-gruvbox-bg2 hover:bg-gruvbox-bg2 active:bg-gruvbox-bg4">
      ...
      <td className="hidden md:table-cell px-4 py-2 whitespace-nowrap text-gruvbox-fg3">{file.dateModified}</td>
      <td className="hidden sm:table-cell px-4 py-2 whitespace-nowrap text-right text-gruvbox-fg3">{file.type}</td>
    </tr>
  );
}
